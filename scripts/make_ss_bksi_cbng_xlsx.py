...
ASSETS = [
    ...
    dict(code="IBT 1 BKASI7", name="IBT 1 Bekasi 500/150 kV", type="IBT 3-Winding",
         tier=2, kv="500/150 kV", ibt="1", bus_hv="BKASI7", bus_lv="BKASI", trafo=1, kerawanan="1"),
    dict(code="IBT 3 BKASI7", name="IBT 3 Bekasi 500/150 kV", type="IBT 3-Winding",
         tier=2, kv="500/150 kV", ibt="3", bus_hv="BKASI7", bus_lv="BKASI", trafo=1, kerawanan="1"),
