...
ASSETS = [
    ...
    dict(code="IBT 1 BDSLN7", name="IBT 1 Bandung Selatan 500/150 kV",
         type="IBT 3-Winding", tier=2, kv="500/150 kV", ibt="1",
         bus_hv="BDSLN7", bus_lv="BDSLN", trafo=1, kerawanan="1", views=BDG),
    dict(code="IBT 2 BDSLN7", name="IBT 2 Bandung Selatan 500/150 kV",
    ...
    dict(code="IBT 1 NUBRG7", name="IBT 1 New Ujungberung 500/150 kV",
         type="IBT 3-Winding", tier=2, kv="500/150 kV", ibt="1",
         bus_hv="NUBRG7", bus_lv="NUBRG5", trafo=1, kerawanan="9", views=NUB),
    dict(code="IBT 2 NUBRG7", name="IBT 2 New Ujungberung 500/150 kV",
         type="IBT 3-Winding", tier=2, kv="500/150 kV", ibt="2",
         bus_hv="NUBRG7", bus_lv="NUBRG5", trafo=1, kerawanan="9", views=NUB),
