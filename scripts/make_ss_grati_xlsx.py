...
ASSETS = [
    ...
    dict(code="IBT 2 GRATI7", name="IBT 2,3 Grati 500/150 kV", type="IBT 3-Winding",
         tier=2, kv="500/150 kV", ibt="2,3", bus_hv="GRATI7", bus_lv="GRATI5",
         trafo=2, simbol="IBT 2,3", kerawanan="1"),
    ...
    # ================= Tier-7 / 8 =================
    dict(code="IBT 1 WLNGI5", name="IBT 1,2 Wlingi 150/70 kV", type="IBT 3-Winding",
         tier=7, kv="150/70 kV", ibt="1,2", bus_hv="WLNGI5", bus_lv="WLNGI4",
         trafo=2, simbol="IBT 1,2", kerawanan="11"),
    ...
    # ================= Tier-9 / 10 / 11 =================
    dict(code="IBT 1 KBAGN", name="IBT 1,2,3 Kebonagung 150/70 kV",
         type="IBT 3-Winding", tier=9, kv="150/70 kV", ibt="1,2,3",
         bus_hv="KBAGN", bus_lv="KBAGN4", trafo=3, simbol="IBT 1,2,3"),
    dict(code="KBAGN4", name="Kebonagung (bus 70 kV)", type="Busbar GI",
         tier=9, kv=70),
    dict(code="SKLNG5", name="Sekarlangit (bus 150 kV)", type="Busbar GI",
         tier=9),
    dict(code="IBT 1 SKLNG5", name="IBT 1,2 Sekarlangit 150/70 kV",
         type="IBT 3-Winding", tier=10, kv="150/70 kV", ibt="1,2",
         bus_hv="SKLNG5", bus_lv="SKLNG4", trafo=2, simbol="IBT 1,2",
         kerawanan="14"),
