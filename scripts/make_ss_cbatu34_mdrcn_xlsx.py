...
ASSETS = [
    ...
    dict(code="IBT 3 CBATU347", name="IBT 3,4 Cibatu 500/150 kV",
         type="IBT 3-Winding", tier=2, kv="500/150 kV", ibt="3,4",
         bus_hv="CBATU347", bus_lv="CBATU34", trafo=2,
         simbol="2 IBT (unit 3,4)", kerawanan="1", views=CBT),
    ...
    dict(code="IBT 1 MDRCN7", name="IBT 1,2 Mandirancan 500/150 kV",
         type="IBT 3-Winding", tier=2, kv="500/150 kV", ibt="1,2",
         bus_hv="MDRCN7", bus_lv="MDRCN5", trafo=2,
         simbol="2 IBT (unit 1,2)", kerawanan="7", views=MDR),
    ...
    dict(code="IBT 1 SYRGI", name="IBT 1,5 Sunyaragi 150/70 kV",
         type="IBT 3-Winding", tier=4, kv="150/70 kV", ibt="1,5",
         bus_hv="SYRGI", bus_lv="SYRGI4", trafo=2,
         simbol="IBT 1 & 5 150/70 kV", kerawanan="10", views=MDR),
