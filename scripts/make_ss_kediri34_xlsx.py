...
ASSETS = [
    ...
    dict(code="KDIRI7", name="GITET Kediri", type="Busbar GITET",
         tier=1, kv="500 kV"),
    dict(code="IBT 3 KDIRI7", name="IBT 3 Kediri 500/150 kV",
         type="IBT 3-Winding", tier=2, kv="500/150 kV", ibt="3",
         bus_hv="KDIRI7", bus_lv="KDIRI5", trafo=1, kerawanan="1"),
    dict(code="IBT 4 KDIRI7", name="IBT 4 Kediri 500/150 kV",
    ...
    dict(code="KIT_TLGNG", name="PLTA Tlagong", type="Pembangkit", tier=6,
         kv="70 kV"),
    dict(code="IBT 1 BNRAN5", name="IBT 1 dan 2,6 Banaran 150/70 kV",
         type="IBT 3-Winding", tier=3, kv="150/70 kV", ibt="1",
         bus_hv="BNRAN5", bus_lv="BNRAN4", trafo=1, kerawanan="7;8"),
    dict(code="IBT 3 BNRAN5", name="IBT 3 dan 2,6 Banaran 150/70 kV",
         type="IBT 3-Winding", tier=3, kv="150/70 kV", ibt="3",
         bus_hv="BNRAN5", bus_lv="BNRAN4", trafo=1, kerawanan="7;8"),
    ...
    dict(code="IBT 1 MNRJO5", name="IBT 1 dan 2 Manisrejo 150/70 kV",
         type="IBT 3-Winding", tier=6, kv="150/70 kV", ibt="1",
         bus_hv="MNRJO5", bus_lv="MNRJO4", trafo=1, kerawanan="12"),
    dict(code="IBT 3 MNRJO5", name="IBT 3 dan 2 Manisrejo 150/70 kV",
         type="IBT 3-Winding", tier=6, kv="150/70 kV", ibt="3",
         bus_hv="MNRJO5", bus_lv="MNRJO4", trafo=1, kerawanan="12"),
