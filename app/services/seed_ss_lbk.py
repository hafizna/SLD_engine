...
CIRCUITS = [
    ...
    ("PHT_BLRJA_SDJYA", "Balaraja - Sindang Jaya", "SUTT", "BLRJA", "SDJYA", 150, None, 2, False, "ENERGIZED", 0.6, "B", "Jalur Balaraja-Sindang Jaya-Suvarna: Sindang Jaya selevel Tier-2 dgn Balaraja, digambar geser ke samping baru turun ke Suvarna (Tier-3). Sindang Jaya juga disuplai dari Lontar."),
    ("PHT_SDJYA_SVRNA", "Sindang Jaya - Suvarna Sutra", "SUTT", "SDJYA", "SVRNA", 150, None, 2, False, "ENERGIZED", 0.5, "B", "Turun dari Sindang Jaya (Tier-2) ke Suvarna Sutra (Tier-3). Suvarna lanjut ke Cikupa lalu Pasar Kemis."),
...
BAYS = [
    ...
    ("ABDGP", "DNYSA", "K", "ENERGIZED", "Bay AGP menggantung di bus Danayasa (ruas Mampang-AGP-Danayasa)"),
    ("MPANG", "DNYSA", "K", "ENERGIZED", "Bay Mampang menggantung di bus Danayasa (ruas Mampang-AGP-Danayasa)"),
